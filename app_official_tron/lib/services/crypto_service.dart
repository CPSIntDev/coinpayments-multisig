...
/// 
/// Data is stored AES-encrypted in SharedPreferences:
/// - Private key is encrypted with AES-256-GCM (authenticated encryption)
/// - Key is derived from password using PBKDF2 with 100,000 iterations
/// - Random salt and nonce are generated for each encryption
class CryptoService {
